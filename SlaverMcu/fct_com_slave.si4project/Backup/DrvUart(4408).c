...
void DrvUart0Init(void)
{
  ...
  UCA0BR0 = 8;                              // 500000/115200 = 4.34(0x4900) 500000/9600 = 52.08(0x0400)
  UCA0MCTLW = 0xd600;                         // 500000/115200 - INT(1000000/115200)=0.34
                                            // UCBRSx value = 0x49 (See UG)  0x4900
  UCA0BR1 = 0;
...
void DrvUart1Init(void)
{
  ...
  UCA1BR0 = 104;                              // 500000/115200 = 4.34(0x4900) 500000/9600 = 52.08(0x0400)
  UCA1MCTLW = 0x1100;                       // 500000/115200 - INT(1000000/115200)=0.34
...

{
  ...
  printf("0x%x  0x%x\n", UCA1IV, __even_in_range(UCA1IV, USCI_UART_UCTXCPTIFG));
