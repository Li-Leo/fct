...
#define WEEK_START 1 //sunday~saturday
#define WEEK_END 7
...
typedef struct
{
	...
	T_U32	month;
    T_U32	date;
	T_S32	week;//1~7, sunday~saturday
	T_U32	hour; 
	T_U32	minute;
	T_U32	second;
} TS_TIME_INFO;
...
typedef struct
{
	T_S16	p_infusion_rec;
	T_S16	p_daytotal_rec;
	T_S16	p_stopinfu_rec;
	T_S16	p_operation_rec;
} TS_RECORD_POINT;
...
typedef enum
{
	...
	E_SYSTEM_PARA_HALL_TO_END_CAL_DATA,	
	E_SYSTEM_PARA_OCCL_CAL_MIN,
	E_SYSTEM_PARA_OCCL_SPEED_CAL_MIN,
	E_SYSTEM_PARA_OCCL_CAL_MAX,
	E_SYSTEM_PARA_OCCL_SPEED_CAL_MAX,
	E_SYSTEM_PAPA_BATTERY_VOLLTAGE_OFFSET,
	E_SYSTEM_PARA_HW_VERSION,
	E_SYSTEM_PARA_SN,
    ...
    E_SYSTEM_PARA_MUTE_STATE,
	//E_SYSTEM_PARA_DAY_TOTAL,
	E_SYSTEM_PARA_USER_SET_DELI_POWER,
	...
	E_SYSTEM_PARA_DELI_START_MOTOR_POS,
	E_SYSTEM_PARA_DELI_IS_RUNNING,
	//E_SYSTEM_PARA_SOFTWARE_VERSION,
	//E_SYSTEM_PARA_DOSE_LEFT,
	//E_SYSTEM_PARA_MOTOR_POS_POINT,
	//E_SYSTEM_PARA_MOTOR_POS_COUNTER,

	E_SYSTEM_PAPA_OCCLUSION_ALARM_FLAG,
	E_SYSTEM_PAPA_RUN_CYCLE_COUNT,
	E_SYSTEM_PAPA_PRESET_DOSE,
	E_SYSTEM_PARA_MAX,
} TE_SYS_PARA;
