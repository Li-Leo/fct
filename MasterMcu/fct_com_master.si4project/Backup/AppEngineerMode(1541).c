...
{
    //T_U8 data = 0x55;
    SendSpiCommandToSlaveEx(HEAD_FC,0x55aa,0x5a5a,0xa5a5);
    //Uart1SendData(&data, 1);
...
static T_S32 AppEngineerModeTestComStop(const T_CHAR* cmd, T_CHAR* params[], T_S32 param_size)
{
...
static const TS_ENGINEER_CMD_HANDLER g_app_engineer_cmd_handlers[] =
{
    ...
    {"test_com", AppEngineerModeTestCom},
    {"test_stop", AppEngineerModeTestComStop},
