...
void DrvUart0Init(void)
{
  ...
  UCA0CTL1 |= UCSSEL__SMCLK;                // CLK = SMCLK=1M
  UCA0BR0 = 8;                              // 1000000/115200 = 8.68(0xD600)   1000000/9600 = 104.17(0x1100)
  UCA0MCTLW = 0xD600;                       // 1000000/115200 - INT(1000000/115200)=0.68
                                            // UCBRSx value = 0xD6 (See UG p579)
  UCA0BR1 = 0;
...
void DrvUart1Init(void)
{
  ...
  UCA1CTL1 |= UCSSEL__SMCLK;                // CLK = SMCLK=1M
  UCA1BR0 = 8;                            // 1000000/115200 = 8.68(0xD600)  1000000/9600 = 104.17(0x1100)
