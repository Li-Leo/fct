...
void SendSpiCommandToSlaveEx(T_U16 head, T_U8 command, T_U8 data )
{
  ...
  spi_send_command.crc_code = crc16((T_U8*)&spi_send_command, 4);
  
  CommSendBytes(E_COMM_INTERNAL_UART, (T_U8*)&spi_send_command, 6);
